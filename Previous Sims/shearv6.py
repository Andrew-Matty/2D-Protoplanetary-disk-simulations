...
#Gravity Field
gravity = dist.Field(name='gravity',bases=(xbasis,ybasis,zbasis))
gravity['g'] = -Lambda**2*z

#Background density
log_rho = dist.Field(name='log_rho',bases=(xbasis,ybasis,zbasis))
log_rho['g'] = -0.5*z**2
...
snapshots.add_task(p, name='vorticity')
